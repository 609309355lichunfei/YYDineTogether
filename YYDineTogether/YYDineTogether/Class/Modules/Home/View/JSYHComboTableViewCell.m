...
@interface JSYHComboTableViewCell ()
...
@implementation JSYHComboTableViewCell
...
- (void)setCombModel:(JSYHComboModel *)combModel {
    ...
    self.priceLabel.text = [_combModel.originalprice stringValue];
