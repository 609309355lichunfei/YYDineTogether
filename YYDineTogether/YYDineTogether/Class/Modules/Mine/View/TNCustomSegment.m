...
- (id)initWithItems:(NSArray *)items withFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor colorWithRed:101 / 255.0 green:171 / 255.0 blue:255 / 255.0 alpha:1.0];
...
- (id)initWithItems:(NSArray *)items withFrame:(CGRect)frame withSelectedColor:(UIColor *)selectedColor withNormolColor:(UIColor *)normolColor withFont:(UIFont *)font{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        if (selectedColor == nil) {
            //self.backgroundColor = [UIColor colorWithRed:101 / 255.0 green:17 / 255.0 blue:25 / 255.0 alpha:1.0];
        }else{
...
- (void)setUpItems:(NSArray *)items withSelectedColor:(UIColor *)selectedColor withNormolColor:(UIColor *)normolColor withFont:(UIFont *)font{
    ...
    for (NSInteger i = 0; i < items.count; i ++) {
        ...
        if (selectedColor == nil) {
          //  [button setTitleColor:[UIColor colorWithRed:101 / 255.0 green:171 / 255.0 blue:255 / 255.0 alpha:1.0] forState:UIControlStateNormal];
           // button.backgroundColor = [UIColor colorWithRed:101 / 255.0 green:171 / 255.0 blue:255 / 255.0 alpha:1.0];
        }else{
    ...
    for (UIButton *otherButton in self.subviews) {
        if (otherButton == selectButton) {
            if (self.selectColor == nil) {
              //  selectButton.backgroundColor = [UIColor colorWithRed:101 / 255.0 green:17 / 255.0 blue:25 / 255.0 alpha:1.0];
            }else{
